...
const PRACTICAL_INFO = [
  ...
  { Icon: CloudSun, label: "Počasí", value: "Aktuální předpověď", note: "Mladé Buky a okolí", href: withBasePath("/#pocasi") },
  { Icon: Video, label: "Webkamera", value: "Živý záběr z okolí", note: "Ski areál Mladé Buky", href: withBasePath("/#webkamera") },
];
      ...
      <main>
        ...
        <section className="px-6 py-16 sm:px-10 sm:py-20 lg:px-[100px] lg:py-24">
          <div className="mx-auto max-w-[1440px]">
            <p className="text-[13px] font-semibold tracking-[2px] text-pec-dark">SEZÓNNÍ CENY</p>
        ...
        <section className="bg-cream px-6 py-14 sm:px-10 lg:px-[100px]">
          <div className="mx-auto max-w-[1440px]">
            <h2 className="font-subhead text-[24px] font-bold text-ink sm:text-[28px]">Co je zahrnuto v ceně</h2>
        ...
        <section className="bg-sand px-6 py-14 sm:px-10 lg:px-[100px]">
          <div className="mx-auto max-w-[1440px]">
            <h2 className="font-subhead text-[22px] font-bold text-ink">Doplňkové poplatky</h2>
        ...
        <section className="bg-cream px-6 py-16 sm:px-10 lg:px-[100px]">
          <div className="mx-auto max-w-[1440px]">
            <h2 className="font-subhead text-[24px] font-bold text-ink sm:text-[28px]">Časté dotazy k ceníku</h2>
            <div className="mt-8">
              <FAQAccordion />
            </div>
          </div>
        ...
        <section className="bg-surface px-6 py-16 sm:px-10 sm:py-20 lg:px-[100px] lg:py-24">
          <div className="mx-auto max-w-[1440px]">
            <p className="text-[13px] font-semibold tracking-[2px] text-pec-dark">PRAKTICKÉ INFORMACE K PŘÍJEZDU</p>
